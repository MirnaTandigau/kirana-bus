...
<head>
    <meta charset="utf-8">
    <title>E-Ticket Charter Kirana Transport</title>
    <style>
        @page { margin: 0px; }
        ...
        .footer { text-align: center; margin-top: 30px; font-size: 10px; color: #94a3b8; line-height: 1.5; }
    </style>
</head>
<body>
    <div class="ticket-card">
        <div class="header">
            ...
            <p>OFFICIAL ELECTRONIC TICKET - <span style="color: #fbbf24;">LAYANAN CHARTER</span></p>
        </div>
        ...
        <div class="main-content">
            <div class="route-header">
                ...
                <h1 style="color: #1e40af; font-weight: 800; font-size: 26px; margin: 0;">
                    {{ str_replace('-', ' - ', strtoupper($ticket->schedule->rute ?? $ticket->rute ?? 'RUTE CHARTER')) }}
                </h1>
                <div style="margin-top: 10px;">
                    <span style="background-color: #dbeafe; color: #1e40af; padding: 4px 12px; border-radius: 15px; font-size: 11px; font-weight: 800; border: 1px solid #bfdbfe;">
                        TIPE: {{ ($ticket->trip_type == 'round_trip') ? 'PULANG PERGI (ROUND TRIP)' : 'SEKALI JALAN (ONE WAY)' }}
                    </span>
                </div>
            </div>
            ...
            <table class="info-grid">
                <tr>
                    <td class="info-box" width="50%">
                        <div class="label">Nama Penyewa / Instansi</div>
                ...
                <tr>
                    <td class="info-box">
                        ...
                        <div class="value">{{ $ticket->titik_jemput ?? $ticket->pickup_point ?? '-' }}</div>
                    </td>
                    <td class="info-box">
                        <div class="label">Titik Tujuan / Turun</div>
                        <div class="value">{{ $ticket->titik_turun ?? $ticket->destination_point ?? '-' }}</div>
                    </td>
                </tr>
            </table>
