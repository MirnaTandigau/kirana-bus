...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow pt-8 md:pt-12 pb-16 md:pb-24 px-4 md:px-6">
        <div class="max-w-5xl mx-auto bg-white p-6 md:p-10 lg:p-14 rounded-3xl shadow-xl shadow-slate-200/40 border border-slate-100">
            <h1 class="text-2xl md:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-4 md:mb-6 border-b-4 border-blue-600 pb-3 md:pb-4 inline-block">Hubungi Kami</h1>
            
            <p class="mb-6 md:mb-8 text-sm md:text-base text-slate-600">Ada pertanyaan? Silakan hubungi agen perwakilan kami di kota Anda melalui WhatsApp.</p>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-6">
                
                <div class="bg-slate-50 p-5 md:p-6 rounded-2xl border border-slate-100 hover:border-blue-300 transition shadow-sm group">
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-3 md:mb-4 uppercase tracking-widest text-[10px] md:text-sm">Kantor Perwakilan Manado</h3>
                    <p class="text-xs md:text-sm text-slate-600 mb-3 flex items-start">
                        <i class="fa-solid fa-map-pin text-red-500 mr-2 md:mr-3 mt-0.5 md:mt-1"></i> 
                        <span>Perum  Citra  Land,  Eden  Bridge  7  No  7,  Kota  Manado</span>
                    </p>
                    <a href="https://wa.me/6281330349900" target="_blank" class="inline-flex items-center text-xs md:text-base text-slate-600 hover:text-green-600 font-bold transition group-hover:underline">
                        <i class="fa-brands fa-whatsapp text-green-500 text-lg md:text-xl mr-2"></i> 0813-3034-9900
                    </a>
                </div>
                
                <div class="bg-slate-50 p-5 md:p-6 rounded-2xl border border-slate-100 hover:border-blue-300 transition shadow-sm group">
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-3 md:mb-4 uppercase tracking-widest text-[10px] md:text-sm">Kantor Perwakilan Tondano</h3>
                    <p class="text-xs md:text-sm text-slate-600 mb-3 flex items-start">
                        <i class="fa-solid fa-map-pin text-red-500 mr-2 md:mr-3 mt-0.5 md:mt-1"></i> 
                        <span>Perum UNIMA, Tondano, Sulawesi Utara</span>
                    </p>
                    <a href="https://wa.me/6285340957541" target="_blank" class="inline-flex items-center text-xs md:text-base text-slate-600 hover:text-green-600 font-bold transition group-hover:underline">
                        <i class="fa-brands fa-whatsapp text-green-500 text-lg md:text-xl mr-2"></i> 0853-4095-7541
                    </a>
                </div>

                <div class="bg-slate-50 p-5 md:p-6 rounded-2xl border border-slate-100 hover:border-blue-300 transition shadow-sm group">
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-3 md:mb-4 uppercase tracking-widest text-[10px] md:text-sm">Kantor Perwakilan Makale</h3>
                    <p class="text-xs md:text-sm text-slate-600 mb-3 flex items-start">
                        <i class="fa-solid fa-map-pin text-red-500 mr-2 md:mr-3 mt-0.5 md:mt-1"></i> 
                        <span>Terminal Makale loket PO. Kirana Tongkonan Transport, Tana Toraja</span>
                    </p>
                    <a href="https://wa.me/6285240816332" target="_blank" class="inline-flex items-center text-xs md:text-base text-slate-600 hover:text-green-600 font-bold transition group-hover:underline">
                        <i class="fa-brands fa-whatsapp text-green-500 text-lg md:text-xl mr-2"></i> 0852-4081-6332
                    </a>
                </div>

                <div class="bg-slate-50 p-5 md:p-6 rounded-2xl border border-slate-100 hover:border-blue-300 transition shadow-sm group">
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-3 md:mb-4 uppercase tracking-widest text-[10px] md:text-sm">Kantor Perwakilan Rantepao</h3>
                    <p class="text-xs md:text-sm text-slate-600 mb-3 flex items-start">
                        <i class="fa-solid fa-map-pin text-red-500 mr-2 md:mr-3 mt-0.5 md:mt-1"></i> 
                        <span>Jl. Andi Mappanyukki, Rantepao, Toraja Utara</span>
                    </p>
                    <a href="https://wa.me/6285255279166" target="_blank" class="inline-flex items-center text-xs md:text-base text-slate-600 hover:text-green-600 font-bold transition group-hover:underline">
                        <i class="fa-brands fa-whatsapp text-green-500 text-lg md:text-xl mr-2"></i> 0852-5527-9166
                    </a>
                </div>

            </div>
            
            <div class="mt-8 md:mt-12 pt-6 md:pt-8 border-t border-slate-100 text-center">
                <p class="text-xs md:text-sm text-slate-600 mb-3 md:mb-4 font-medium">Layanan Pengaduan Konsumen (Email):</p>
                <a href="mailto:cs@kiranatransport.com" class="text-blue-600 font-extrabold text-lg md:text-2xl hover:underline">cs@kiranatransport.com</a>
            </div>
        </div>
    </main>
