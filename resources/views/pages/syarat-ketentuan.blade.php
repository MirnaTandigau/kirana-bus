...
<body class="bg-slate-50 text-slate-800 antialiased flex flex-col min-h-screen">
    ...
    <main class="flex-grow pt-8 md:pt-12 pb-16 md:pb-24 px-4 md:px-6">
        <div class="max-w-4xl mx-auto bg-white p-6 md:p-10 lg:p-14 rounded-3xl shadow-xl shadow-slate-200/40 border border-slate-100">
            <h1 class="text-2xl md:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-4 md:mb-6 border-b-4 border-blue-600 pb-3 md:pb-4 inline-block">Syarat & Ketentuan</h1>
            
            <div class="space-y-6 md:space-y-8 text-slate-600 leading-relaxed text-sm md:text-base">
                
                <section>
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-2 md:mb-3">1. Pemesanan & Pembayaran Tiket</h3>
                    <ul class="list-disc list-inside space-y-1.5 md:space-y-2">
                ...
                <section>
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-2 md:mb-3">2. Diskon Khusus Mahasiswa</h3>
                    <ul class="list-disc list-inside space-y-1.5 md:space-y-2">
                ...
                <section>
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-2 md:mb-3">3. Layanan Ekspedisi (Kargo)</h3>
                    <ul class="list-disc list-inside space-y-1.5 md:space-y-2">
                ...
                <section>
                    <h3 class="text-base md:text-lg font-bold text-slate-900 mb-2 md:mb-3">4. Pembatalan & Keterlambatan</h3>
                    <ul class="list-disc list-inside space-y-1.5 md:space-y-2">
