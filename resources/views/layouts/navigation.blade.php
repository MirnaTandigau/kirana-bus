            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('admin.cargos.index')" :active="request()->routeIs('admin.cargos.*')">
                            {{ __('Manajemen Ekspedisi') }}
                        </x-nav-link>

                        <x-nav-link :href="route('admin.explore.index')" :active="request()->routeIs('admin.explore.*')">
                            {{ __('Explore') }}
                        </x-nav-link>
                    @else
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->is_admin)
                ...
                <x-responsive-nav-link :href="route('admin.cargos.index')" :active="request()->routeIs('admin.cargos.*')">
                    {{ __('Manajemen Ekspedisi') }}
                </x-responsive-nav-link>
            @endif
        </div>
